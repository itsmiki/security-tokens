...
class QR_Code(Token):
    ...
    def create_token(self, ip, port = None):
        ...
        self.path = os.path.dirname(os.path.abspath(__file__)) + '/qr_codes/' + self.token_id + '.png'
...
if __name__ == "__main__":
    test_session = Session('sesja_1', '123.12.13.43')
    ...
    qrcode_test1.create_token(test_session.ip, "3000")
    # print(qrcode_test1.text_url)
    # print(qrcode_test1.img_path)

    qrcode_test2 = QR_Code(test_session, "QR_Code2")
    qrcode_test2.create_token(test_session.ip, "3000")
